...
(function($) {
     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               if (getURLP('q'))
               {
                    $('#tipue_search_input_mobile').val(getURLP('q'));
               ...
               {
                    $('#tipue_search_content_mobile').hide();
                    var out = '';
                    var results = '';
                    ...
                    var d = $('#tipue_search_input_mobile').val().toLowerCase();
                    d = $.trim(d);
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {                                   
                                        ...
                                        if (set.showURL)
                                        {  
                                             out += '<div class="tipue_search_content_mobile_url"><a href="' + fo[3] + '"' + tipue_search_w + '>' + fo[3] + '</a></div>';
                                        }
                                        ...
                                        out += '<div class="tipue_search_content_mobile_text">' + t_d + '</div>';
                                   }
                                   l_o++;     
                              }
                    ...
                    $('#tipue_search_content_mobile').html(out);
                    $('#tipue_search_content_mobile').slideDown(200);
